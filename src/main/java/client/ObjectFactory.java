...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://impl.service/", "download");
    private final static QName _Upload_QNAME = new QName("http://impl.service/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://impl.service/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://impl.service/", "uploadResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service/", name = "uploadResponse")
